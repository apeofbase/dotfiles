    ...
    config = function()
      ...
      require('telescope').setup {
        ...
        extensions = {
          ...
          live_grep_args = {
            auto_quoting = true, -- Automatically quote search terms
          },
        },
      ...
      -- Live grep args custom shortcuts
      ...
      -- Advance search for word under cursor
      vim.keymap.set('n', '<leader>sw', function()
        live_grep_args.live_grep_args {
          default_text = '-F --hidden ' .. vim.fn.expand '<cword>' .. '', -- Get the word under the cursor
        }
      end, { desc = '[S]earch [W]ord under cursor' })

      vim.keymap.set('n', '<leader>sW', function()
        live_grep_args.live_grep_args {
          default_text = '-F --hidden --no-ignore ' .. vim.fn.expand '<cword>' .. '', -- Get the word under the cursor
        }
      end, { desc = '[S]earch [W]ord under cursor (no ignore)' })

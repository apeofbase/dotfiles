return {
  ...
  },
  {
    ...
    dependencies = {
      ...
      { 'williamboman/mason.nvim', version = '^2.0.0', opts = {} },
    ...
    config = function()
      ...
      local servers = {
        eslint = {
          ...
          cmd = { 'vscode-eslint-language-server', '--stdio' }, -- Ensure ESLint language server is installed
          root_dir = require('lspconfig.util').root_pattern('.eslintrc*', 'package.json', '.git'), -- Detect project root
          ...
          on_attach = function(client, bufnr)
            -- Enable formatting on save using ESLint
            vim.api.nvim_create_autocmd('BufWritePre', {
              buffer = bufnr,
              command = 'EslintFixAll',
            })

            -- Disable formatting for other LSPs to avoid conflicts
